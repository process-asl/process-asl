# -*- coding: utf-8 -*-
#
# procasl documentation build configuration file, created by
...
latex_documents = [
  ('index', 'procasl.tex', u'procasl Documentation',
   u'Bougacha', 'manual'),
]
...
man_pages = [
    ('index', 'procasl', u'procasl Documentation',
     [u'Bougacha'], 1)
]
...
texinfo_documents = [
  ('index', 'procasl', u'procasl Documentation',
   u'Bougacha', 'procasl', 'One line description of project.',
   'Miscellaneous'),
]
